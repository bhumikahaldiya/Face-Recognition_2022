...
window = tk.Tk()
window.title("Face Recognisation")
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:\Users\LENOVO\Desktop\Face Recognition\Attendance\Manually Attendance/ attendance.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\LENOVO\Desktop\Face Recognition\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\LENOVO\Desktop\Face Recognition\Attendance\Manually Attendance\atttendance.csv"')
    ...
    def log_in():
        ...
        if username == 'bhumi' :
            if password == 'bhumi2022':
                ...
                cs = ('C:\Users\LENOVO\Desktop\Face Recognition\StudentDetails/StudentDetails.csv')
...
def mask_recog():
    x='C:/Users/LENOVO/Desktop/covid/facemask/caffe/facede/models/deploy.prototxt.txt'
    y='C:/Users/LENOVO/Desktop/covid/facemask/caffe/facede/models/res10_300x300_ssd_iter_140000.caffemodel'

#Load Model
    print("Loading model...................")
    net = cv2.dnn.readNetFromCaffe(x,y)
    model=load_model('C:/Users/LENOVO/mask_recog_ver2.h5')
...
# from each other
    ...
    weightsPath = 'C:/Users/LENOVO/Downloads/yolov3.weights'
    configPath = 'C:/Users/LENOVO/Desktop/covid/facemask/yolov3/cfg/yolov3.cfg'
    net = cv2.dnn.readNetFromDarknet(configPath, weightsPath)
    labelsPath = 'C:/Users/LENOVO/Desktop/covid/facemask/coco.names'
    ...
    def video_stream():
        ...
        cap = cv2.VideoCapture('C:/Users/LENOVO/Desktop/tensorflow/Social_Distancing-CV-master/Social_Distancing-CV-master/people.mp4')
        writer = None
        while True:
